...
app.createBooks('O Hobbit', '...', 'fantasy', 300, authors[0], '...', 19.99, 100)
app.createBooks('A Sociedade do Anel', '...', 'fantasy', 400, authors[0], '...', 24.99, 100)
app.createBooks('O Ladrão de Raios', '...', 'fantasy', 500, authors[1], '...', 24.99, 100)
app.createBooks('A Pirâmide Vermelha', '...', 'fantasy', 600, authors[1], '...', 24.99, 100)
